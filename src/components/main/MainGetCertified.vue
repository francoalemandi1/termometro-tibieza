<template>
  <section class="lg:max-w-4xl mx-4">
    <h1 class="lg:text-4xl text-2xl font-bold tracking-normal lg:mt-4 my-4 mx-4 lg:px-0 leading-relaxed">
      Sacá tu certificado de tibieza!
    </h1>
